{
  ...
  inputs = {
    ...
    cl-cc-vm = {
      url = "github:nerima-lisp/cl-cc-vm/f0d04ad";
      flake = false;
    };
    cl-cc-ir = {
    ...
    cl-cc-optimize = {
      url = "github:nerima-lisp/cl-cc-optimize/f020798";
      flake = false;
    };
    cl-cc-codegen-native = {
      url = "github:nerima-lisp/cl-cc-codegen-native/93bf76d";
      flake = false;
    };
    cl-cc-parse = {
    ...
    cl-cc-php = {
      url = "github:nerima-lisp/cl-cc-php/c3f01ba353d11225e38be6ceb52b4e13d2045c63";
      flake = false;
    };
    cl-cc-javascript = {
      url = "github:nerima-lisp/cl-cc-javascript/7ab09451e4b540ab9d43d7cb56d72245b22a768c";
      flake = false;
    };
    cl-cc-runtime = {
      url = "github:nerima-lisp/cl-cc-runtime/e7d2419";
      flake = false;
    };
