{
  ...
  inputs = {
    ...
    cl-cc-optimize = {
      url = "github:nerima-lisp/cl-cc-optimize/1489bb63d5fb882dc55a2bd13cccdca2ef322404";
      flake = false;
    };
    cl-cc-codegen-native = {
      url = "github:nerima-lisp/cl-cc-codegen-native/505e7edf23744fb1abb66dbbb563bf5fccb5eee6";
      flake = false;
    };
    cl-cc-parse = {
