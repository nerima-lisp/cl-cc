...
(it-sequential "tooling-advanced-2-runtime-safety" (labels ((signals-error-p (thunk message-fragment) (handler-case (progn (funcall thunk) nil) (error (condition) (search message-fragment (princ-to-string condition) :test (function char-equal)))))) (cl-cc/jit:card-table-init 4096 2048 :young-start 4096 :young-end 4608 :old-start 4608 :old-end 6144) (expect (= 0 (cl-cc/jit:card-index 4096)) :to-be-truthy) (expect (= 3 (cl-cc/jit:card-index 5632)) :to-be-truthy) (expect (cl-cc/jit:old-to-young-reference-p 4608 4096) :to-be-truthy) (expect (not (cl-cc/jit:old-to-young-reference-p 4607 4096)) :to-be-truthy) (expect (signals-error-p (lambda () (cl-cc/jit:card-index 6144)) "outside") :to-be-truthy) (expect (signals-error-p (lambda () (cl-cc/jit:emit-write-barrier nil 0)) "unsupported") :to-be-truthy) (let ((cl-cc/jit::*jit-native-code-enabled* t)) (cl-cc/jit:init-safepoint-page) (expect (not cl-cc/jit:*safepoint-armed-p*) :to-be-truthy) (cl-cc/jit:arm-safepoint) (expect cl-cc/jit:*safepoint-armed-p* :to-be-truthy) (cl-cc/jit:disarm-safepoint) (expect (not cl-cc/jit:*safepoint-armed-p*) :to-be-truthy)) (expect (signals-error-p (lambda () (cl-cc/jit:install-call-stub (quote unsafe-stub) #())) "unsupported") :to-be-truthy) (expect (signals-error-p (lambda () (cl-cc/jit::get-compile-stub-address)) "unsupported") :to-be-truthy) (expect (signals-error-p (lambda () (let ((cl-cc/jit:*trace-jit-enabled* t) (cl-cc/jit::*jit-native-code-enabled* t)) (cl-cc/jit:compile-trace (list :entry-pc 0 :instructions nil :guards nil)))) "unsupported") :to-be-truthy) (expect (signals-error-p (lambda () (cl-cc/jit:emit-guarded-inline nil (quote unsafe-inline) 0 nil)) "unsupported") :to-be-truthy) (expect (signals-error-p (lambda () (cl-cc/jit:emit-megamorphic-dispatch nil 0 nil)) "unsupported") :to-be-truthy) (expect (= 120 (length *tooling-advanced-2-all-fr-ids*)) :to-be-truthy)))
