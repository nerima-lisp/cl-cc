;;;; packages/codegen/src/wasm-aot.lisp - AOT Wasm compilation helpers
;;;
;;; Tool integration, deterministic module ordering, content hashes,
;;; SRI output, and compile-to-aot-wasm.
