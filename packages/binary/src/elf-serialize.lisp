;;;; packages/binary/src/elf-serialize.lisp — ELF64 section/header serialization
;;;
;;; Lays out and serializes ELF64 output for both object files and executables:
;;;   - LEB128 / alignment byte-buffer helpers
;;;   - .eh_frame and .eh_frame_hdr construction
;;;   - .symtab / .rela / .dynsym / .dynamic section bytes
;;;   - section-header, program-header and dynamic-entry writers
;;;   - elf64-finalize-relocatable / elf64-finalize-executable / elf64-finalize
;;;
...
;;;
;;; Load order: after emit/binary/elf.lisp, before emit/binary/elf-emit.lisp.
...
(defun elf64-finalize (builder)
  ...
  (elf64-verify-wx (elf64-phdrs builder))
