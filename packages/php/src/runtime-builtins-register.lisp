...
(defun %php-register-all-builtins ()
  ...
  (%php-register-builtin "deg2rad" '%php-deg2rad)
  (%php-register-builtin "rad2deg" '%php-rad2deg)
  (%php-register-builtin "decbin"  '%php-decbin)
  (%php-register-builtin "decoct"  '%php-decoct)
  (%php-register-builtin "dechex"  '%php-dechex)
  ...
  (%php-register-builtin "gmmktime" '%php-mktime)
  ...
  (%php-register-builtin "gmp_init"   '%php-gmp-init)
  (%php-register-builtin "gmp_add"    '%php-gmp-add)
  (%php-register-builtin "gmp_sub"    '%php-gmp-sub)
  (%php-register-builtin "gmp_mul"    '%php-gmp-mul)
  (%php-register-builtin "gmp_div_q"  '%php-gmp-div-q)
  (%php-register-builtin "gmp_div"    '%php-gmp-div-q)
  (%php-register-builtin "gmp_mod"    '%php-gmp-mod)
  (%php-register-builtin "gmp_pow"    '%php-gmp-pow)
  (%php-register-builtin "gmp_abs"    '%php-gmp-abs)
  (%php-register-builtin "gmp_neg"    '%php-gmp-neg)
  (%php-register-builtin "gmp_gcd"    '%php-gmp-gcd)
  (%php-register-builtin "gmp_cmp"    '%php-gmp-cmp)
  (%php-register-builtin "gmp_intval" '%php-gmp-intval)
  (%php-register-builtin "gmp_strval" '%php-gmp-strval)
  (%php-register-builtin "gmp_sqrt"   '%php-gmp-sqrt)
  (%php-register-builtin "gmp_fact"   '%php-gmp-fact)
  ;; bcmath extension
