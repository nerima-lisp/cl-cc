...
(defun %build-stdlib-vm-snapshot ()
  ...
  (let* ((*accessor-slot-map*       (make-hash-table :test #'eq))
         ...
         (*setf-compound-place-handlers* (cl-cc/pipeline::%copy-snapshot-ht *setf-compound-place-handlers*))
    ...
    (setf *stdlib-accessor-slot-map*       (cl-cc/pipeline::%copy-snapshot-ht *accessor-slot-map*)
          *stdlib-defstruct-read-only-accessor-map* (cl-cc/pipeline::%copy-snapshot-ht *defstruct-read-only-accessor-map*)
          *stdlib-defstruct-slot-registry* (cl-cc/pipeline::%copy-snapshot-ht *defstruct-slot-registry*)
          *stdlib-defstruct-type-registry* (cl-cc/pipeline::%copy-snapshot-ht *defstruct-type-registry*)
          *stdlib-defstruct-predicate-registry* (cl-cc/pipeline::%copy-snapshot-ht *defstruct-predicate-registry*)
          *stdlib-setf-compound-place-handlers* (cl-cc/pipeline::%copy-snapshot-ht *setf-compound-place-handlers*))
